class HRZ_CraftCigsCannabisTop extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Dreh Joint";
		...
		InsertIngredient(0,"HRZ_CannabisTop");//you can insert multiple ingredients this way
		...
		//ingredient 2
		InsertIngredient(1, "HRZ_RollingPapers");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("HRZ_JointTop");//add results here
