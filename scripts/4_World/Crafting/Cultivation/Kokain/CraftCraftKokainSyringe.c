class HRZ_CraftKokainSyringe extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Spritze befüllen";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"HRZ_Kokain_Pack");
		...
		//ingredient 2
		InsertIngredient(1, "HRZ_Syringe");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("HRZ_Kokain_Syringe");//add results here
