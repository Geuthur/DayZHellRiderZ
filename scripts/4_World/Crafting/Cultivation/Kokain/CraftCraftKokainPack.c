class HRZ_CraftKokainPack extends RecipeBase
{	
	override void Init()
	{
		...
		//ingredient 2
		InsertIngredient(1,"HRZ_Kokain_Pack");//you can insert multiple ingredients this way
