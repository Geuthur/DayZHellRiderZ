class HRZ_CraftKokain extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Kokain Verpacken";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"HRZ_Empty_Pack");
		...
		//ingredient 2
		InsertIngredient(1, "HRZ_Kokain");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("HRZ_Kokain_Pack");//add results here
