class HRZ_CraftWhistle extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Schnitze dir Wolfspfeife";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"HRZ_Holzbalken");
		...
		//ingredient 2
		InsertIngredient(1, "HRZ_Chisel");//you can insert multiple ingredients this way
		InsertIngredient(1, "CombatKnife");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("HRZ_Whistle_Wolf");//add results here
