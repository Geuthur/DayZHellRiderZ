class HRZ_craftWolfcowl extends RecipeBase
{	
	override void Init()
	{
		m_Name = "Stelle Wolfspelz Her";
		...
		//ingredient 2
		InsertIngredient(1,"WolfPelt");//you can insert multiple ingredients this way
		...
		//result1
		AddResult("HRZ_Wolffurcowl");//add results here
