class HRZ_ActionFoldShemaghScarf : ActionSingleUseBase
{
	void HRZ_ActionFoldShemaghScarf ()
	{
	...
	override void OnExecuteServer ( ActionData action_data )
	{
		...
		{
			string str = "HRZ_Shemagh_Scarf_" + old_item.ConfigGetString("color");
