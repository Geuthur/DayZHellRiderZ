class HRZ_ActionFoldShemaghFacemask : ActionSingleUseBase
{
	void HRZ_ActionFoldShemaghFacemask ()
	{
	...
	override void OnExecuteServer ( ActionData action_data )
	{
		...
		{
			string str = "HRZ_Shemagh_Facemask_" + old_item.ConfigGetString("color");
