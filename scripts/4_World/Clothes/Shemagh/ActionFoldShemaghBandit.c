class HRZ_ActionFoldShemaghBandit : ActionSingleUseBase
{
	void HRZ_ActionFoldShemaghBandit ()
	{
	...
	override void OnExecuteServer ( ActionData action_data )
	{
		...
		{
			string str = "HRZ_Shemagh_Bandit_" + old_item.ConfigGetString("color");
