class HRZ_ActionReadPaperCB : ActionContinuousBaseCB
{
...
class HRZ_ActionReadPaper: ActionContinuousBase
{
	void HRZ_ActionReadPaper()
	{
		m_CallbackClass = HRZ_ActionReadPaperCB;
